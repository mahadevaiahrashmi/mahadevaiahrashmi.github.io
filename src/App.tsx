            ...
            >
              <div className="flex justify-between items-start mb-6">
                ...
                <div className="flex flex-wrap gap-4 justify-end">
                  <a href="https://htmlpreview.github.io/?https://github.com/mahadevaiahrashmi/EkAdhyapak-Sahayak/blob/main/index.html" target="_blank" rel="noopener noreferrer" className="opacity-60 hover:opacity-100 transition-opacity flex items-center gap-1.5 text-xs font-sans uppercase tracking-widest" title="Live Demo">
                    Live <ExternalLink size={14} />
                  </a>
                  ...
                  <Link to="/blog/ekadhyapak-sahayak" className="opacity-60 hover:opacity-100 transition-opacity flex items-center gap-1.5 text-xs font-sans uppercase tracking-widest" title="Case Study">
                    Case Study <ExternalLink size={14} />
                  </Link>
                </div>
              </div>
              <p className="text-lg leading-relaxed opacity-80 mb-6">
                AI companion for single-teacher multi-grade primary schools. Differentiated lesson plans, worksheets, FLN oral assessments and daily timetables — offline-first, English by default.
              </p>
              <div className="flex flex-wrap gap-2 mt-auto">
