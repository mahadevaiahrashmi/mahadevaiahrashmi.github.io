// agent-notes: { ctx: "OpenEnv play2 setup walkthrough blog post content", deps: ["react-router-dom", "../../components/blog-helpers"], state: active, last: "sato@2026-04-18", key: ["extracted from BlogPost.tsx for #29 split"] }
/**
 * @license
