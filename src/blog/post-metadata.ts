...
export const blogPosts: BlogPost[] = [
  {
    ...
    title: "EkAdhyapak Sahayak: One Teacher, Many Grades, One AI Companion",
    subtitle: "An offline-first teaching assistant for single-teacher multi-grade government primary schools — differentiated plans, FLN oral checks, and timetables designed for the real classroom",
    date: "2026-09-20",
    readTime: "7 min read",
