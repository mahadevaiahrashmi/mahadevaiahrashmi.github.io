// agent-notes: { ctx: "blog post metadata (titles, slugs, tags, excerpts); bodies live in ./posts/*", deps: [], state: active, last: "2026-09-20", key: ["restored full list after deploy failure; OneTeacher entry"] }
/**
 * @license
...
export const blogPosts: BlogPost[] = [
  {
    ...
    subtitle: "AI companion for single-teacher multi-grade primary schools — English by default; Tamil, Telugu, Kannada, Malayalam, Hindi available",
    date: "2026-09-20",
    readTime: "7 min read",
    tags: ["Applied AI", "EdTech", "FLN", "Prompt Engineering", "HTML"],
    excerpt:
      "A single HTML file that turns one topic into multi-grade lesson plans, differentiated worksheets, and FLN oral assessments for government primary schools where one teacher handles Grades 1–5. Case study in constraint-driven AI product design — offline-first, teacher-in-control, multi-grade native.",
  },
  {
